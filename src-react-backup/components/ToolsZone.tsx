  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        style={{
          background: 'linear-gradient(165deg, rgba(50, 35, 22, 0.9) 0%, rgba(20, 14, 10, 0.95) 100%)',
          border: '1px solid',
            ...
            {tools.map((tool, index) => {
              ...
              return (
                <motion.a
                  ...
                  style={{
                    background: 'linear-gradient(165deg, rgba(50, 35, 22, 0.95) 0%, rgba(22, 15, 10, 0.98) 100%)',
