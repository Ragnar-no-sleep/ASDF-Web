    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          height: '240px',
          background:
            'radial-gradient(circle, rgba(245, 158, 11, 0.1) 0%, rgba(234, 179, 8, 0.03) 50%, transparent 70%)',
          filter: 'blur(25px)',
        }}
      />
      ...
      <motion.div
        ...
        whileHover={{
          scale: 1.05,
          boxShadow:
            '0 0 150px rgba(234, 179, 8, 0.2), 0 0 80px rgba(245, 158, 11, 0.12), 0 30px 60px rgba(0, 0, 0, 0.5), inset 0 0 60px rgba(0, 0, 0, 0.3)',
        }}
        className="relative flex flex-col items-center justify-center w-[200px] h-[200px] rounded-full cursor-pointer"
        style={{
          background:
            'linear-gradient(165deg, rgba(55, 40, 25, 0.95) 0%, rgba(22, 16, 10, 0.98) 100%)',
