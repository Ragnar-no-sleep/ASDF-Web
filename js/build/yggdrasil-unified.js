...
import { MOCK_BURN_STATS, MOCK_LESSONS, MOCK_CONTRIBUTORS } from './yggdrasil-mock-data.js';
...
const YggdrasilCosmos = {
  ...
  // Mock data (imported from yggdrasil-mock-data.js)
  mockBurnStats: MOCK_BURN_STATS,
  mockLessons: MOCK_LESSONS,
  mockContributors: MOCK_CONTRIBUTORS,
