...
const GAMES = [
  ...
  },
  {
    ...
    type: 'Endless Runner',
    description:
      'Run through the blockchain, collect tokens, avoid obstacles. Every token collected gets burned!',
  },
  {
    id: 'scamblaster',
    name: 'Scam Blaster',
  ...
  },
  {
    ...
    type: 'Action',
    description:
      'Navigate the crypto underworld! Steal tokens, evade the SEC, and escape with your loot!',
  },
  {
    id: 'whalewatch',
    name: 'Whale Watch',
  ...
  },
  {
    ...
    type: 'Strategy',
    description:
      'Conquer blockchain territories! Deploy validators, capture nodes, and dominate the network!',
  },
  {
    id: 'liquiditymaze',
    name: 'Liquidity Maze',
