...
function validateStateSchema(data) {
    ...
    if (data.competitiveTimeUsed !== undefined) {
        if (typeof data.competitiveTimeUsed !== 'number' || !Number.isFinite(data.competitiveTimeUsed) || data.competitiveTimeUsed < 0) return false;
    }
    ...
    if (data.competitiveSessionStart !== undefined && data.competitiveSessionStart !== null) {
        if (typeof data.competitiveSessionStart !== 'number' || !Number.isFinite(data.competitiveSessionStart)) return false;
    }
