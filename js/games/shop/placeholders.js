...
const ShopPlaceholders = {
  ...
  drawAura(ctx, colors, size) {
    ...
    // Inner glow
    ctx.globalAlpha = 0.4;
    const innerGradient = ctx.createRadialGradient(center, center, 0, center, center, size / 3);
...
if (typeof window !== 'undefined') {
  ...
  window.ASDF.ShopPlaceholders = ShopPlaceholders;
  window.ShopPlaceholders = window.ASDF.ShopPlaceholders;
  window.ASDF.TIER_COLORS = TIER_COLORS;
  window.TIER_COLORS = window.ASDF.TIER_COLORS;
}
