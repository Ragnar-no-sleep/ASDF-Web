            ...
            <div class="shop-filters">
                ...
                <div class="filter-group">
                    ...
                    <div class="filter-buttons">
                        ${FILTER_CONFIG.ownershipOptions
                          .map(
                            opt => `
  ...
  applyFilters(items, context = {}) {
    ...
    if (this.filters.search) {
      ...
      filtered = filtered.filter(item => {
        ...
        return (
          name.includes(searchLower) || desc.includes(searchLower) || layer.includes(searchLower)
        );
      });
    }
...
if (typeof window !== 'undefined') {
  ...
  window.ASDF.ShopFilters = ShopFilters;
  window.ShopFilters = window.ASDF.ShopFilters;
}
