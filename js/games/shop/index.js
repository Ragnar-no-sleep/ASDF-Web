...
const ShopV2 = {
  ...
  showPurchaseModal(item, currency) {
    const prices = this.currency
      ? this.currency.getPrices(item)
      : { burn: item.price, ingame: item.ingame_price };
...
if (typeof window !== 'undefined') {
  ...
  window.ASDF.ShopV2 = ShopV2;
  window.ShopV2 = window.ASDF.ShopV2;
}
