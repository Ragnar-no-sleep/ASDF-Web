...
if (typeof window !== 'undefined') {
  ...
  window.ASDF.ShopParticles = ShopParticles;
  window.ShopParticles = window.ASDF.ShopParticles;
  window.ASDF.PARTICLE_EFFECTS = PARTICLE_EFFECTS;
  window.PARTICLE_EFFECTS = window.ASDF.PARTICLE_EFFECTS;
}
