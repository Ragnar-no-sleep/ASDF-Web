...
if (typeof window !== 'undefined') {
  ...
  window.ASDF.ShopPurchase = ShopPurchase;
  window.ShopPurchase = window.ASDF.ShopPurchase;
  window.ASDF.BurnPurchase = BurnPurchase;
  window.BurnPurchase = window.ASDF.BurnPurchase;
}
