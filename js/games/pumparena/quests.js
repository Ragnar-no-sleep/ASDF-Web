        ...
        quests: [
          {
            ...
            type: 'main',
            objectives: [{ type: 'meet_npc', target: 'marcus', description: 'Meet Marcus Chen' }],
          ...
          },
          {
            ...
            description:
              'Complete your first real task for SafeYield. Show any of your skills to contribute.',
            type: 'main',
            ...
            dialogue: {
              intro:
                "It's time to show what you can do. Choose a path that matches your strengths!",
      ...
      },
      {
        ...
        quests: [
          ...
          },
          {
            ...
            objectives: [{ type: 'choice', description: 'Decide how to handle the vulnerability' }],
            ...
            objectives: [
              {
                type: 'talk_npc',
                target: 'sarah',
                description: 'Coordinate with Sarah on communications',
              },
        ...
        quests: [
          {
            ...
            type: 'main',
            objectives: [{ type: 'meet_npc', target: 'alex', description: 'Meet Alex Reyes' }],
            rewards: { xp: 100, reputation: 20, tokens: 50 },
            dialogue: {
              intro:
                "Pixel Raiders' studio is full of energy. Game development in progress everywhere.",
              complete:
                "Alex's vision is inspiring. This could be the game that changes everything.",
            },
          },
          {
            id: 'pr_q1_compete',
            ...
            objectives: [
              {
                ...
                game: 'raid_simulator',
                minScore: 500,
                description: 'Score 500+ in Raid Simulator',
              },
            ],
          ...
          },
          {
            ...
            objectives: [{ type: 'meet_npc', target: 'mika', description: 'Meet Mika Tanaka' }],
        ...
        quests: [
          {
            ...
            objectives: [
              { type: 'talk_npc', target: 'mika', description: 'Register with Mika' },
              {
                ...
                resource: 'influence',
                min: 30,
                description: 'Have enough influence to compete',
              },
            ],
          ...
          },
          {
            ...
            objectives: [
              ...
              },
              {
                ...
                game: 'chart_analysis',
                minScore: 400,
                description: 'Sharpen your analysis',
              },
            ],
            ...
            choices: [
              {
                ...
                outcomes: {
                  xpBonus: 200,
                  reputationBonus: 100,
                  achievement: 'tournament_champion',
                },
              },
              {
                id: 'top_3',
      ...
      },
      {
        ...
        quests: [
          ...
          },
          {
            ...
            objectives: [{ type: 'choice', description: 'Decide your path' }],
        ...
        quests: [
          {
            ...
            type: 'main',
            objectives: [{ type: 'meet_npc', target: 'jordan', description: 'Meet Jordan Blake' }],
            rewards: { xp: 100, reputation: 25, tokens: 50 },
            dialogue: {
              intro: 'Based Collective runs differently. Everyone has a voice here.',
              complete:
                "Jordan's patient explanation helps you understand the power of collective decision-making.",
            },
          },
          {
            id: 'bc_q1_culture',
            ...
            objectives: [{ type: 'meet_npc', target: 'nova', description: 'Meet Nova' }],
          ...
          },
          {
            ...
            objectives: [{ type: 'choice', description: 'Vote on the proposal' }],
      ...
      },
      {
        ...
        quests: [
            ...
            objectives: [
              {
                ...
                game: 'raid_simulator',
                minScore: 800,
                description: 'Lead the raid to victory',
              },
            ],
          ...
          },
          {
            ...
            type: 'main',
            requires: ['bc_q2_raid'],
            objectives: [{ type: 'choice', description: 'Handle the attention' }],
      ...
      },
      {
        ...
        quests: [
          ...
          },
          {
            ...
            objectives: [{ type: 'choice', description: 'Cast your final vote' }],
    ...
    chapters: [
      {
        ...
        quests: [
          ...
          },
          {
            ...
            objectives: [{ type: 'meet_npc', target: 'elena', description: 'Meet Elena Santos' }],
            rewards: { xp: 100, reputation: 25, tokens: 50 },
            dialogue: {
              intro: 'Dmitri mentioned Elena would help you get oriented.',
              complete:
                "Elena is warm and welcoming. A breath of fresh air after Dmitri's intensity.",
            },
          },
          {
            id: 'nf_q1_first_pr',
        ...
        quests: [
          ...
          },
          {
            ...
            objectives: [
              ...
              },
              {
                ...
                stat: 'dev',
                min: 12,
                description: 'Implement advanced optimizations',
              },
            ],
          ...
          },
          {
            ...
            dialogue: {
              ...
              complete:
                'We crushed it. 3x better than their current solution. NodeForge is going mainstream.',
            },
          },
        ],
      },
      {
        ...
        quests: [
          ...
          },
          {
            ...
            objectives: [
              { type: 'stat_check', stat: 'cha', min: 8, description: 'Lead the new team' },
              {
                ...
                stat: 'dev',
                min: 14,
                description: 'Maintain technical excellence',
              },
            ],
            rewards: { xp: 400, reputation: 150, tokens: 250 },
            dialogue: {
          ...
          },
          {
            ...
            type: 'main',
            requires: ['nf_q3_lead'],
            objectives: [{ type: 'choice', description: 'Choose your role in the future' }],
            ...
            dialogue: {
              ...
              complete:
                'Your path is set. The foundation you helped build will stand for generations.',
            },
          },
        ],
      },
...
const SIDE_QUESTS = [
  {
    ...
    objectives: [{ type: 'choice', description: 'Solve the riddle' }],
  ...
  },
  {
    ...
    dialogue: {
      intro:
        "Dmitri rarely asks for help. 'I have a problem. I think you might see it differently.'",
  ...
  },
  {
    ...
    dialogue: {
      ...
      complete:
        "The proposal passes. Jordan credits you publicly. 'Co-authored by a true builder.'",
    },
  },
  {
    id: 'sq_first_alpha',
  ...
  },
  {
    ...
    objectives: [{ type: 'stat_check', stat: 'com', min: 6, description: 'Share your knowledge' }],
    ...
    objectives: [
      {
        ...
        game: 'chart_analysis',
        minScore: 350,
        description: 'Execute a profitable trade',
      },
    ],
  ...
  },
  {
    ...
    type: 'side',
    requires: { level: 2 },
    objectives: [{ type: 'stat_check', stat: 'mkt', min: 3, description: 'Create viral content' }],
  ...
  },
  {
    ...
    type: 'daily',
    requires: { level: 1 },
    objectives: [{ type: 'stat_check', stat: 'str', min: 1, description: 'Practice discipline' }],
  ...
  },
  {
    ...
    type: 'side',
    requires: { level: 4 },
    objectives: [{ type: 'stat_check', stat: 'cha', min: 5, description: 'Make new connections' }],
  ...
  },
  {
    ...
    type: 'daily',
    requires: { level: 3 },
    objectives: [{ type: 'battle', minWins: 1, description: 'Win a battle' }],
...
function startQuest(questId) {
  ...
  document.dispatchEvent(
    new CustomEvent('pumparena:quest-started', {
...
function completeQuest(questId) {
  ...
  document.dispatchEvent(
    new CustomEvent('pumparena:quest-completed', {
...
function checkCampaignProgress(campaignId, chapterId, completedQuestId) {
  ...
  const completedInChapter = questsInChapter.filter(qId =>
    questState.completedQuests.includes(qId)
  );
  ...
  if (completedInChapter.length === questsInChapter.length) {
    ...
    if (nextChapter) {
      ...
      document.dispatchEvent(
        new CustomEvent('pumparena:campaign-completed', {
          detail: { campaign },
        })
      );
    }
