      ...
      work: {
        ...
        dialogues: {
          stranger: {
            ...
            options: [
              {
                text: 'That sounds thorough',
                response: "It's the only way. Too many projects rush to market and pay the price.",
                affinity: 2,
              },
              {
                text: "Isn't that slow?",
                response: 'Speed kills in DeFi. Ask any project that got exploited.',
                affinity: -1,
              },
            ],
          },
            ...
            options: [
              {
                text: 'Tell me more',
                response:
                  'Every major decision goes through a 7-day timelock. No shortcuts, even for me.',
                affinity: 5,
                xp: 25,
              },
              {
                text: 'Sounds bureaucratic',
                response: 'Bureaucracy saves funds. Trust me on this.',
                affinity: 0,
              },
            ],
          },
          partner: {
            ...
            options: [
              {
                text: "I'm in. Let's design it.",
                response: 'I knew I could count on you. This stays between us for now.',
                affinity: 10,
                xp: 100,
                unlocks: 'safeyield_insurance_quest',
              },
      ...
      personal: {
        ...
        dialogues: {
          friend: {
            ...
            options: [
              {
                text: "I'm sorry. That must have been hard.",
                response: 'It was. But it gave me purpose. Never again.',
                affinity: 8,
              },
              {
                text: 'At least you learned from it',
                response: 'Cold comfort at the time. But yes.',
                affinity: 3,
              },
            ],
          },
            ...
            options: [
              {
                ...
                response: "Then let's build something that outlasts us both.",
                affinity: 15,
                achievement: 'marcus_partner',
              },
            ],
          },
        },
            ...
            options: [
              {
                ...
                response: 'Common sense. Sadly not common enough.',
                affinity: 2,
                xp: 15,
              },
            ],
            ...
            options: [
              {
                ...
                response:
                  'The 2022 crash taught me that. Some people showed their true colors. Others... became lifelong allies.',
                affinity: 5,
                xp: 40,
              },
            ],
      ...
      community: {
        ...
        dialogues: {
          stranger: {
            ...
            options: [
              {
                text: 'How do you build that?',
                response: 'One genuine conversation at a time. No shortcuts!',
                affinity: 3,
              },
              {
                text: 'Sounds idealistic',
                response: 'Maybe! But idealists change the world. Cynics just watch.',
                affinity: 0,
              },
            ],
          },
          friend: {
            ...
            options: [
              {
                text: "That's impressive dedication",
                response: "It takes time but it's worth it. People feel seen.",
                affinity: 5,
                xp: 20,
              },
              {
                text: 'How do you scale that?',
                response: 'You train others to do the same. Culture is contagious!',
                affinity: 3,
                xp: 15,
              },
            ],
            ...
            options: [
              {
                ...
                response: 'YAY! This is going to help so many builders!',
                affinity: 12,
                xp: 150,
                unlocks: 'community_playbook_quest',
              },
            ],
          },
        },
      ...
      personal: {
        ...
        dialogues: {
          friend: {
            ...
            options: [
              {
                text: "That's what makes you great at this",
                response: 'You think? Sometimes it just feels exhausting.',
                affinity: 6,
                xp: 25,
              },
              {
                text: 'You should set boundaries',
                response: "I know, I know... it's just hard when people need help.",
                affinity: 4,
              },
            ],
          },
          partner: {
            ...
            options: [
              {
                text: 'Same here. It means a lot.',
                response: "*hugs* Okay I'm getting emotional. But seriously, thank you.",
                affinity: 15,
                achievement: 'sarah_partner',
              },
            ],
          },
        },
      ...
      fun: {
        ...
        dialogues: {
          acquaintance: {
            ...
            options: [
              {
                text: 'The one about gas fees? Classic!',
                response: 'YES! Someone added the crying cat and I lost it!',
                affinity: 3,
              },
            ...
            options: [
              {
                ...
                response: 'Right?! No prizes, no competition, just vibes!',
                affinity: 5,
                xp: 20,
              },
              {
                text: 'Could be chaotic',
                response: "EMBRACE THE CHAOS! That's where the magic happens!",
                affinity: 3,
              },
            ],
          },
      ...
      game: {
        ...
        dialogues: {
            ...
            options: [
              {
                ...
                response:
                  'You make a game people would play WITHOUT the tokens. Then you add them.',
                affinity: 3,
                xp: 10,
              },
            ...
            options: [
              {
                text: 'Show me!',
                response:
                  "*shows tablet* It's called 'The Founding Dev'. Easter egg that rewards OG players.",
                affinity: 8,
                xp: 50,
              },
          ...
          partner: {
            ...
            options: [
              {
                text: "Let's make gaming history!",
                response: "NOW you're talking! First design doc due next week!",
                affinity: 15,
                xp: 200,
                unlocks: 'pixel_raiders_expansion',
              },
            ],
          },
        },
        ...
        dialogues: {
          acquaintance: {
            ...
            options: [
              {
                text: 'Can I compete?',
                response: 'Season 2 open qualifiers start soon. Practice up.',
                affinity: 3,
                xp: 15,
              },
              {
                text: "Who's sponsoring?",
                response: "Can't say yet. But big names are interested.",
                affinity: 2,
              },
            ],
          },
            ...
            options: [
              {
                ...
                response: "You've got skill. And more importantly, you understand the game's soul.",
                affinity: 10,
                xp: 75,
                unlocks: 'esports_team_member',
              },
            ],
          },
        },
      ...
      tech: {
        ...
        dialogues: {
            ...
            options: [
              {
                text: 'How?',
                response:
                  'Parallel transaction processing. State sharding. No magic. Just engineering.',
                affinity: 3,
                xp: 20,
              },
              {
                text: 'Impressive numbers',
                response: 'Numbers mean nothing without reliability. We have both.',
                affinity: 2,
              },
            ],
          },
          friend: {
            ...
            options: [
              {
                text: 'These latencies are incredible',
                response: "Still not good enough. But we're getting there.",
                affinity: 8,
                xp: 60,
              },
              {
                ...
                response:
                  "Consensus finality. Always consensus. It's a physics problem as much as CS.",
                affinity: 10,
                xp: 80,
              },
            ],
          ...
          partner: {
            ...
            options: [
              {
                text: "I'm honored. Yes.",
                response:
                  'Good. First task: review the L3 architecture proposal. Have notes ready by Monday.',
                affinity: 15,
                xp: 250,
                unlocks: 'nodeforge_colead',
              },
            ],
          },
        },
      ...
      philosophy: {
        ...
        dialogues: {
          friend: {
            ...
            options: [
              {
                text: "The tool doesn't decide. Users do.",
                response: "Convenient answer. But tools shape behavior. We're not neutral.",
                affinity: 5,
                xp: 30,
              },
              {
                text: 'Heavy thoughts for a Tuesday',
                response: '*almost smiles* Every day is good for existential doubt.',
                affinity: 3,
              },
            ],
          },
          partner: {
            ...
            options: [
              {
                text: 'Meaning matters more than money',
                response: 'Exactly. Though money helps fund the meaning.',
                affinity: 12,
                achievement: 'dmitri_partner',
              },
            ],
          },
        },
      ...
      art: {
        ...
        dialogues: {
          stranger: {
            ...
            options: [
              {
                text: 'The community does',
                response: 'Correct answer! Gold star for you.',
                affinity: 5,
              },
              {
                text: 'Usually the founders',
                response: "Cynical but often true. That's what we're trying to change.",
                affinity: 2,
              },
            ],
          },
            ...
            options: [
              {
                text: "I'm honored",
                response:
                  "*shows phone* It's a generative meme engine. AI trained on 5 years of CT culture.",
                affinity: 10,
                xp: 50,
              },
              {
                text: 'Why me?',
                response:
                  'Because you actually get it. Most people just see pixels. You see language.',
                affinity: 8,
              },
            ],
          },
            ...
            options: [
              {
                ...
                response: "I know. That's why you're the first. *removes mask* Hi. Real me.",
                affinity: 20,
                achievement: 'nova_identity',
                xp: 300,
              },
            ],
          },
        ...
        dialogues: {
          acquaintance: {
            ...
            options: [
              {
                text: 'Solid 8/10',
                response: "I'll take it. The wojak could be better but the caption slaps.",
                affinity: 4,
              },
              {
                text: '9/10 banger',
                response: "Okay now I don't trust you. Nobody gives 9s.",
                affinity: 3,
              },
            ],
          },
          friend: {
            ...
            options: [
              {
                text: "We're all playing characters",
                response: 'EXACTLY! The meta-awareness makes it art!',
                affinity: 8,
                xp: 40,
              },
              {
                text: 'Too deep for a Wednesday',
                response: 'Every day is meme day. There is no Wednesday.',
                affinity: 5,
              },
            ],
          },
      ...
      wisdom: {
        ...
        dialogues: {
            ...
            options: [
              {
                ...
                response: 'Specificity is the enemy of truth. Embrace ambiguity.',
                affinity: 2,
              },
              {
                text: "That's frustratingly vague",
                response: 'Frustration is clarity trying to emerge. Good.',
                affinity: 5,
              },
            ],
          },
          friend: {
            ...
            options: [
              {
                text: 'What do the patterns say now?',
                response:
                  'Consolidation precedes transformation. Whether up or down... that depends on you.',
                affinity: 8,
                xp: 50,
              },
              {
                text: 'Are you ever just... wrong?',
                response: 'Always. And also never. Time is circular.',
                affinity: 6,
              },
            ],
          },
          partner: {
            ...
            options: [
              {
                text: 'Thank you, Oracle.',
                response: 'Thank yourself. You walked the path. I merely pointed.',
                affinity: 20,
                xp: 500,
                achievement: 'oracle_prophecy',
              },
            ],
          },
        },
      ...
      riddles: {
        ...
        dialogues: {
            ...
            options: [
              {
                text: 'Knowledge',
                response:
                  'Acceptable. But also: trust, community, alpha. All grow when shared wisely.',
                affinity: 5,
                xp: 30,
              },
              {
                text: 'Reputation',
                response: 'Hmm. Interesting interpretation. Not wrong.',
                affinity: 3,
                xp: 20,
              },
            ],
          ...
          ally: {
            ...
            options: [
              {
                text: "Time. You can't buy back missed opportunities.",
                response: 'Profound. And correct. You have learned well.',
                affinity: 15,
                xp: 100,
              },
              {
                text: 'Genuine community trust.',
                response: 'Also true. Perhaps there are multiple answers after all.',
                affinity: 12,
                xp: 80,
              },
            ],
      ...
      alpha: {
        ...
        dialogues: {
          friend: {
            ...
            options: [
              {
                text: "I'll watch it. Thank you.",
                response: "Don't thank me yet. Prove you can act on information.",
                affinity: 8,
                xp: 100,
              },
              {
                text: 'Can you tell me more?',
                response: "No. Either trust me or don't. There is no middle.",
                affinity: 3,
              },
            ],
          },
            ...
            options: [
              {
                ...
                response:
                  "*whispers* DePIN for satellites. Space crypto. 18 months out. You're welcome.",
                affinity: 20,
                xp: 500,
                achievement: 'whale_alpha',
                tokens: 500,
              },
            ],
          },
      ...
      trust: {
        ...
        dialogues: {
          stranger: {
            ...
            options: [
              {
                text: 'I have nothing to prove. Actions speak.',
                response: "Hmm. Confident. We'll see if it's earned.",
                affinity: 5,
              },
              {
                text: 'Because I keep my mouth shut.',
                response: "That's the right answer. Discretion is everything in this game.",
                affinity: 8,
                xp: 25,
              },
            ],
          ...
          ally: {
            ...
            options: [
              {
                text: 'Nothing. Just respect.',
                response: "Then you've earned it. Welcome to the inner circle.",
                affinity: 15,
                achievement: 'whale_trust',
              },
              {
                text: 'Access to your network.',
                response: 'Direct. I appreciate that. Earn it step by step.',
                affinity: 10,
              },
            ],
          },
...
const DIALOGUE_TEMPLATES = {
  ...
  greeting_by_stage: {
    stranger: ["Oh, it's you again.", 'Did you need something?', "We've met before, right?"],
    acquaintance: ['Hey, good to see you!', 'Back again? Nice.', "How's it going?"],
    friend: [
...
function meetNPC(npcId) {
  ...
  if (!npcState.metNPCs.includes(npcId)) {
    ...
    const templates =
      DIALOGUE_TEMPLATES.first_meeting[npc.dialogueStyle] ||
      DIALOGUE_TEMPLATES.first_meeting.casual;
    const template = templates[Math.floor(Math.random() * templates.length)];
    const dialogue = template.replace('{playerName}', playerName).replace('{npcName}', npc.name);
...
function changeAffinity(npcId, amount) {
  ...
  if (relationship.stage !== oldStage) {
    document.dispatchEvent(
      new CustomEvent('pumparena:relationship-stage-change', {
        detail: {
          npcId,
          npc: NPCS[npcId],
          oldStage,
...
function selectDialogueOption(optionIndex) {
  ...
  // Dispatch event
  document.dispatchEvent(
    new CustomEvent('pumparena:dialogue-complete', {
      detail: {
        npcId,
        npc,
        topicId,
            ...
            ${
              Object.keys(results.rewards).length > 0
                ...
                <div class="dialogue-rewards">
                    ${
                      results.rewards.affinity
                        ? `<span class="reward ${results.rewards.affinity > 0 ? 'positive' : 'negative'}">
