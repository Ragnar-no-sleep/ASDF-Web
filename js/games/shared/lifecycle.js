...
const GameLifecycle = {
    ...
    startGame(gameId) {
        ...
        const isCompetitive = typeof activeGameModes !== 'undefined' && activeGameModes[gameId] === 'competitive';
    ...
    async endGame(gameId, finalScore) {
        ...
        if (safeScore > 0 && typeof addXpFromGame === 'function') {
            ...
            if (xpResult.success) {
                ...
                if (xpResult.tieredUp && typeof showTierUpCelebration === 'function' && typeof ASDF !== 'undefined') {
