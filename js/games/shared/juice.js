...
if (typeof window !== 'undefined') {
  ...
  window.ASDF.GameJuice = GameJuice;
  window.GameJuice = window.ASDF.GameJuice;
  window.ASDF.JUICE_PRESETS = JUICE_PRESETS;
  window.JUICE_PRESETS = window.ASDF.JUICE_PRESETS;
  window.ASDF = window.ASDF || {};
  window.ASDF.JUICE_TIMING = JUICE_TIMING;
  window.JUICE_TIMING = window.ASDF.JUICE_TIMING;

  // Legacy helpers
  window.ASDF = window.ASDF || {};
  window.ASDF.updateParticles = updateParticles;
  window.updateParticles = window.ASDF.updateParticles;
