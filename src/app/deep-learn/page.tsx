  ...
  return (
    <aside className="hidden lg:block sticky top-24 h-fit space-y-4">
      ...
      <div className="bg-hub-elevated border border-ragnar/20 rounded-xl p-5">
        ...
        <div className="font-mono text-xs uppercase tracking-widest text-warm-ghost mb-4">Progress</div>
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <div className="font-mono text-xs text-warm-ghost">
                    {section.xp > 0 ? `+${section.xp} XP` : section.id === 'analytics' ? 'Live Data' : ''}
                  </div>
                </div>
                {isLocked && <span>🔒</span>}
              </button>
    ...
    >
      <div className="bg-hub-elevated border border-ragnar/20 rounded-xl p-8">
        ...
        <p className="text-warm-secondary">
          You know the "This is Fine" meme - the dog sitting in a burning room. That's our mascot and philosophy.
          In crypto chaos, most tokens pump and dump. ASDF turns the chaos into fuel.
        </p>
      </div>
      ...
      <div className="bg-hub-elevated border border-ragnar/20 rounded-xl p-8">
        ...
        <p className="text-warm-secondary mb-4">
          ...
          They're gone forever. No one can access them - ever.
        </p>
        <p className="text-warm-secondary mb-4">
        ...
        <div className="space-y-4">
          <div className="p-5 bg-hub-base rounded-lg border-l-4 border-warm-ghost">
            ...
            <div className="text-sm text-warm-secondary">
              Crypto markets are wild. Prices swing 50% in a day. Most panic. We accept the chaos as fuel.
            </div>
          </div>
          ...
          <div className="p-5 bg-gradient-to-r from-hub-base to-ragnar/10 rounded-lg border-l-4 border-ragnar">
            ...
            <div className="text-sm text-warm-secondary">
              ...
              The dog drinks coffee because he understands - and builds through the flames.
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-4 p-5 bg-gradient-to-r from-ragnar/10 to-hub-base rounded-lg">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-warm-secondary">Active ecosystem participant, using tools generates fees</div>
            </div>
          ...
          <div className="flex items-center gap-4 p-5 bg-hub-base border border-ragnar/10 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <div className="text-sm text-warm-secondary">Entry point - conviction demonstrated by holding</div>
            </div>
    ...
    >
      <div className="bg-hub-elevated border border-ragnar/20 rounded-xl p-8">
        ...
        <p className="text-center text-warm-ghost text-sm italic mt-4">
          More trading → More fees → More burns → Less supply → More scarcity → More trading... repeat.
        </p>
      </div>
...
function QuizSection() {
  const { addXP, completeSection, completedSections, unlockBadge, quizProgress, setQuizLevel, setQuizPerfect } = useLearn()
...
function PlaySection() {
  ...
  const [stats, setStats] = useState({ diamond: 50, knowledge: 20, community: 30, portfolio: 1000 })
  ...
  const getArchetype = () => {
    if (stats.diamond >= 80) return { icon: '💎', name: 'Diamond Hand Legend', desc: 'Unshakeable conviction. Nothing phases you.' }
    if (stats.knowledge >= 80) return { icon: '🧠', name: 'Scholar', desc: 'Knowledge is power. You understand the ecosystem deeply.' }
    if (stats.community >= 80) return { icon: '🤝', name: 'Community Leader', desc: 'The heart of the ecosystem. You bring people together.' }
    if (stats.portfolio >= 500000) return { icon: '🐋', name: 'Whale', desc: 'Massive bags. You believe in the vision.' }
  ...
  if (!completedSections.includes('quiz')) {
    return (
      ...
      >
        ...
        <p className="text-warm-secondary">Finish the Quiz section to unlock the Holder's Journey.</p>
      </motion.div>
    )
  }
  ...
  if (!started) {
    return (
      ...
      >
        ...
        <p className="text-lg text-warm-secondary mb-8">Navigate the chaos. Learn the truth. THIS IS FINE.</p>
          ...
          <div key={i} className="bg-hub-elevated border border-ragnar/20 rounded-xl overflow-hidden">
            ...
            <AnimatePresence>
              {openIndex === i && (
                ...
                >
                  <div className="px-5 pb-5 text-warm-secondary leading-relaxed">
                    {faq.a}
                  </div>
                </motion.div>
              )}
