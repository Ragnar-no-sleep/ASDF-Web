...
function DragReveal({ onComplete, isCompleted }: { onComplete: () => void; isCompleted: boolean }) {
  ...
  return (
    <div ref={constraintsRef} className="relative py-8">
      ...
      >
        {/* Track */}
        <div className="absolute inset-0 flex items-center justify-end pr-6 text-warm-ghost font-mono text-sm">
  ...
  return (
    <div className="py-8">
        ...
        {tools.map(tool => {
          ...
          return (
            ...
            >
              ...
              <span
                className={`font-mono text-sm ${isExplored ? 'text-gold-400' : 'text-warm-secondary'}`}
              >
                {tool.name}
              </span>
              {isExplored && (
      ...
      {isCompleted && (
        ...
        >
          <p className="text-gold-400 font-mono text-sm">Tu connais l'écosystème. Prêt à build?</p>
        </motion.div>
      )}
    </div>
  );
      ...
      <div className="max-w-xl w-full">
        ...
        >
          <span
            ...
            style={{
              background: isCompleted ? 'rgba(234,179,8,0.2)' : 'rgba(201,184,154,0.1)',
...
export default function LearnPage() {
  ...
  const currentLevel =
    completedPhases.length === 0 ? 'Moldu' : completedPhases.length < 3 ? 'Initié' : 'Croyant';
        ...
        {allCompleted && (
          ...
          >
            <div className="max-w-xl text-center">
              ...
              >
                Tu comprends. Tu vérifies. Tu burns.
                <br />
