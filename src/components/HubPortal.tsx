...
const portalIcons: Record<string, React.ComponentType<{ className?: string; animated?: boolean }>> = {
  learn: LearnIcon,
  build: BuildIcon,
    ...
    >
      ...
      {available && (
        <motion.div
          ...
          style={{
            background: 'radial-gradient(circle at 50% 30%, rgba(234, 179, 8, 0.12) 0%, transparent 70%)',
