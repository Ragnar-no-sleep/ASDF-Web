    ...
    <main id="main-content">
        <section class="featured-section" aria-labelledby="featured-title">
            ...
            <div class="countdown" role="timer" aria-label="Time until next game rotation">
                <div class="countdown-item"><span class="countdown-value" id="countdown-days">${days}</span><span class="countdown-label">Days</span></div>
                <div class="countdown-item"><span class="countdown-value" id="countdown-hours">${padZero(hours)}</span><span class="countdown-label">Hours</span></div>
                <div class="countdown-item"><span class="countdown-value" id="countdown-mins">${padZero(mins)}</span><span class="countdown-label">Minutes</span></div>
                <div class="countdown-item"><span class="countdown-value" id="countdown-secs">${padZero(secs)}</span><span class="countdown-label">Seconds</span></div>
            </div>
            <button class="btn btn-primary featured-play-btn" data-action="play-featured">Play Now</button>
        </section>
        <section class="leaderboard-section" aria-labelledby="leaderboard-title">
            ...
            <div class="leaderboard-tabs" role="tablist">
                <button class="leaderboard-tab active" data-period="weekly" role="tab" aria-selected="true">Weekly</button>
                <button class="leaderboard-tab" data-period="cycle" role="tab" aria-selected="false">Cycle</button>
            </div>
            <div class="leaderboard-list active" id="weekly-leaderboard" role="tabpanel">${weeklyHtml}</div>
            <div class="leaderboard-list" id="cycle-leaderboard" role="tabpanel">${cycleHtml}</div>
        </section>
        <section class="games-section" id="games-section" aria-labelledby="games-title">
            <h2 id="games-title">All Games</h2>
            <div class="games-grid" id="games-grid">${gamesGridHtml}</div>
        </section>
